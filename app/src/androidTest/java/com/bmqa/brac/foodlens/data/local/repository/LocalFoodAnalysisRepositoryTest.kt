...
import com.bmqa.brac.foodlens.data.local.database.dao.FoodAnalysisDao
...
class LocalFoodAnalysisRepositoryTest {
    ...
    private fun createTestFoodAnalysis(summary: String = "Test analysis summary"): com.bmqa.brac.foodlens.domain.entities.GeminiFoodAnalysis {
        return com.bmqa.brac.foodlens.domain.entities.GeminiFoodAnalysis(
            isError = false,
            errorMessage = "",
            foodItems = listOf(
                com.bmqa.brac.foodlens.domain.entities.GeminiFoodItem(
                    name = "Test Food Item",
                    portion = "100g",
            ...
            totalNutrition = com.bmqa.brac.foodlens.domain.entities.TotalNutrition(
                name = "Test Meal",
                totalPortion = "100g",
                totalCalories = 200,
                totalProtein = "20g",
