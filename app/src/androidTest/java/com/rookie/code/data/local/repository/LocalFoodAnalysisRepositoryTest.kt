package com.rookie.code.data.local.repository

import android.content.Context
import androidx.room.Room
import androidx.test.core.app.ApplicationProvider
import androidx.test.ext.junit.runners.AndroidJUnit4
import com.rookie.code.data.local.database.FoodLensDatabase
...
class LocalFoodAnalysisRepositoryTest {
    ...
    private fun createTestFoodAnalysis(summary: String = "Test analysis summary"): com.rookie.code.domain.entities.GeminiFoodAnalysis {
        return com.rookie.code.domain.entities.GeminiFoodAnalysis(
            isError = false,
            errorMessage = "",
            foodItems = listOf(
                com.rookie.code.domain.entities.GeminiFoodItem(
                    name = "Test Food Item",
                    portion = "100g",
            ...
            totalNutrition = com.rookie.code.domain.entities.TotalNutrition(
                name = "Test Meal",
                totalPortion = "100g",
                totalCalories = 200,
                totalProtein = "20g",
